  ...
  <div>
    ...
    <el-form :inline="true" :model="queryForm">
      ...
      <el-form-item label="性别">
        <el-select size="small" v-model="queryForm.sex" width="370px" filterable clearable>
...
export default {
  ...
  methods: {
    ...
    toDelete(row) {
      this.$confirm('确定删除【' + row.name + '】患者吗?', '提示', {
